...
const Contact = () => {
  ...
  return (
    ...
    <section className="bg-green-50 dark:bg-slate-800 mt-[7rem]" id="contact">
    <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        <div className="mb-4">
            <div className="flex flex-col gap-4 mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12">
                <div className="text-base font-semibold uppercase tracking-wide text-[#8EC63F] dark:text-blue-200">
                ...
                <div className="card h-fit max-w-6xl p-5 md:p-12" id="form">
                    ...
                    <form id="contactForm">
                        <div className="mb-6">
                            ...
                            <div className="mx-0 mb-1 sm:mb-4">
                                <label htmlFor="textarea" className="pb-1 text-xs uppercase tracking-wider"></label><textarea id="textarea" name="textarea" cols="30" rows="5" placeholder="Write your message..." className="mb-2 w-full rounded-md border border-gray-400 py-2 pl-2 pr-4 shadow-md dark:text-gray-300 sm:mb-0"/>
                            </div>
                        </div>
                        <div className="text-center">
                            <button type="submit" className="w-full bg-[#8EC63F] text-gray-800 px-6 py-3 font-xl rounded-md sm:mb-0">Send Message</button>
                        </div>
                    </form>
                </div>
            </div>
